...
import com.blackbelt.github.api.GitHubApiService
import com.blackbelt.githubcodechallenge.BuildConfig
...
class NetworkModule {
    ...
    fun provideGitHubApiServie(
            ...
            rxJava2CallAdapterFactory: RxJava2CallAdapterFactory): GitHubApiService {
